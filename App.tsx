...
import Signup from './src/Phase-1 (Authentication)/Signup/signupScreen';
import OtpForSignup from './src/Phase-1 (Authentication)/Signup/otpForSignup';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="SplashScreen" screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="Otp" component={OtpForSignup} />
